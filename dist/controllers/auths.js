...
let AuthController = class AuthController {
    constructor() {
        this.authS = enum_1.services.Auth;
    }
    login(loginUserDto) {
        return __awaiter(this, void 0, void 0, function* () {
            //const { username,passwordHash}=loginUserDto
            let user = yield this.authS.login(loginUserDto);
            if (user)
                return { message: "Login Succefully", user: user };
            else
    ...
    register(user) {
        return __awaiter(this, void 0, void 0, function* () {
            let _user;
            _user = yield this.authS.create(user);
            return _user;
        });
    }
};
