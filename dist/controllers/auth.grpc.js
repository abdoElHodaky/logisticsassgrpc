    ...
    login(res, loginUserDto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                errors = yield (0, dto_1.validatorDto)(dto_1.LoginUserDto, loginUserDto);
                console.log(empty);
                ...
                if (errors.length == 0) {
                    ...
                    try {
                        ...
                        res.status(400).json({ message: err === null || err === void 0 ? void 0 : err.message });
                    }
                }
                else {
...
__decorate([
    (0, express_1.Post)("/login", [middlewares_1.ValidatedLogin]),
