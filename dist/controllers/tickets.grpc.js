...
exports.GrpcTicketController = void 0;
const grpc_js_1 = require("@grpc/grpc-js");
const dist_1 = require("../protos/dist/");
const express_1 = require("@decorators/express");
const address = "localhost:51";
let GrpcTicketController = class GrpcTicketController {
    constructor() {
...
__decorate([
    (0, express_1.Get)("/:id/tickets"),
    __param(0, (0, express_1.Res)()),
    __param(1, (0, express_1.Params)("id")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], GrpcTicketController.prototype, "all", null);
GrpcTicketController = __decorate([
    (0, express_1.Controller)("/users")
], GrpcTicketController);
exports.GrpcTicketController = GrpcTicketController;
