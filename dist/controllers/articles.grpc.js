...
let GrpcArticleController = class GrpcArticleController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.client.all(req, (err, resp) => {
                if (err) {
                    ...
                    const resl = dist_1._Article.GetAllRes.toJSON(resp);
    ...
    create(req, res, createarticledto) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const errors = yield (0, dto_1.validatorDto)(dto_1.CreateArticleDto, createarticledto);
            console.log(empty);
            try {
                if (errors.length == 0) {
                    try {
                        ...
                        res.status(400).jsonp({ message: err === null || err === void 0 ? void 0 : err.message });
                    }
                }
                else {
...
__decorate([
    (0, express_1.Post)("", [middlewares_1.AuthenticateMiddleware, middlewares_1.AuthorMiddleware, middlewares_1.ValidatedCreatedArticle]),
    __param(0, (0, express_1.Req)()),
    __param(1, (0, express_1.Res)()),
    __param(2, (0, express_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, dto_1.CreateArticleDto]),
    __metadata("design:returntype", Promise)
