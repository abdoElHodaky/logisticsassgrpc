...
let cacheWithRedis = apicache_1.default.options({ redisClient: redis.createClient() }).middleware;
app.use((0, express_2.urlencoded)({ extended: true }));
app.use((0, cors_1.default)());
app.use((0, express_2.json)());
app.use(cacheWithRedis("15 minutes", (req, res) => res.statusCode === 200));
app.use(routes_1.apiv1);
/*app.use(rateLimit({
    windowMs: 15 * 60 * 1000, // 15 minutes
    limit: 100, // Limit each IP to 100 requests per `window` (here, per 15 minutes).
    }))*/
app.use(expressPrettier({ alwaysOn: true }));
...
const configureApplication = () => __awaiter(void 0, void 0, void 0, function* () {
