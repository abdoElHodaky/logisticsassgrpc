...
class AuthorService extends datasource_1._Data {
    ...
    all() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let users = yield this.datasource.getRepository(entity_1.Author).find({
                    relations: {
                        tickets: true,
                        articles: true
                    },
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (authord instanceof entity_1.User) {
                    //author.type="author"
                    dauthor = yield this.datasource.manager.create(entity_1.Author, Object.assign({}, authord //,type:"author"
                    ));
