        ...
        this.SrvImpl = {
            ...
            create(call, callback) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    const { title, content, imgurl } = dist_1._Article.Article.fromJSON((article != undefined) ? article : dist_1._Article.createBaseArticle());
                    //console.log({...article})
                    let _article = yield ArticleGrpcService.service.create({
                        userId: userId,
                        article: {
                            title: title,
                            content: content,
                    ...
                    if (_article instanceof entity_1.Article) {
                        const article = dist_1._Article.Article.fromJSON(_article);
                        ...
                        callback(null, { article: dist_1._Article.createBaseArticle() });
                    }
                });
            }
        };
