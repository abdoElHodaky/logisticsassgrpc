...
exports.User = {
    set(message, prop, value) {
        if (prop == "articles")
            message.articles = value;
        if (prop == "tickets")
            message.tickets = value;
    },
    get(message, prop) {
        if (prop == "articles")
            return message === null || message === void 0 ? void 0 : message.articles;
        if (prop == "tickets")
            return message === null || message === void 0 ? void 0 : message.tickets;
    },
    keys(message) {
        return [
            "id",
    ...
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (message.email !== undefined) {
            exports.User_Email.encode(message.email, writer.uint32(50).fork()).ldelim();
        }
        if (message.passwordHash !== undefined) {
            writer.uint32(58).string(message.passwordHash);
        }
        for (const v of message.articles) {
            article_1.Article.encode(v, writer.uint32(66).fork()).ldelim();
        }
        for (const v of message.tickets) {
            ticket_1.Ticket.encode(v, writer.uint32(74).fork()).ldelim();
        }
        if (message.address !== undefined) {
            address_1.Address.encode(message.address, writer.uint32(82).fork()).ldelim();
        }
    ...
    fromPartial(object) {
        ...
        message.email = (object.email !== undefined && object.email !== null)
            ...
            : undefined;
        message.passwordHash = (_f = object.passwordHash) !== null && _f !== void 0 ? _f : undefined;
        message.articles = ((_g = object.articles) === null || _g === void 0 ? void 0 : _g.map((e) => article_1.Article.fromPartial(e))) || [];
        message.tickets = ((_h = object.tickets) === null || _h === void 0 ? void 0 : _h.map((e) => ticket_1.Ticket.fromPartial(e))) || [];
