...
export const User = {
  encode(message: User, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.email !== undefined) {
      User_Email.encode(message.email, writer.uint32(66).fork()).ldelim();
    }
    if (message.passwordHash !== undefined) {
      writer.uint32(74).string(message.passwordHash);
    }
    for (const v of message.articles) {
      Article.encode(v!, writer.uint32(82).fork()).ldelim();
    }
    for (const v of message.tickets) {
      Ticket.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    for (const v of message.payments) {
      Payment.encode(v!, writer.uint32(98).fork()).ldelim();
    }
    for (const v of message.subscriptions) {
      Subscription.encode(v!, writer.uint32(106).fork()).ldelim();
    }
    if (message.address !== undefined) {
      Address.encode(message.address, writer.uint32(114).fork()).ldelim();
    }
    if (message.referedBy !== undefined) {
      writer.uint32(122).string(message.referedBy);
    }
    if (message.referralCode !== undefined) {
      writer.uint32(130).string(message.referralCode);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<User>, I>>(object: I): User {
    ...
    message.IDcardNumber = object.IDcardNumber ?? undefined;
    ...
    message.address = (object.address !== undefined && object.address !== null)
      ...
      : undefined;
    message.referedBy = object.referedBy ?? undefined;
