...
export interface CreateSubOrgzRes {
  ownerId?: number | undefined;
  branch: Orgz | undefined;
}

export interface CreateSubOrgzReq {
  ownerId: number;
  parentorgzId: number;
  branch: Orgz | undefined;
}
...
export const Orgz = {
  encode(message: Orgz, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.branches) {
      Orgz.encode(v!, writer.uint32(34).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.branches.push(Orgz.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
  ...
  fromJSON(object: any): Orgz {
    return {
      ...
      branches: globalThis.Array.isArray(object?.branches) ? object.branches.map((e: any) => Orgz.fromJSON(e)) : [],
  ...
  toJSON(message: Orgz): unknown {
    ...
    if (message.branches?.length) {
      obj.branches = message.branches.map((e) => Orgz.toJSON(e));
    }
    if (message.createdAt !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Orgz>, I>>(object: I): Orgz {
    ...
    message.branches = object.branches?.map((e) => Orgz.fromPartial(e)) || [];
...
function createBaseCreateSubOrgzRes(): CreateSubOrgzRes {
  return { ownerId: undefined, branch: undefined };
}

export const CreateSubOrgzRes = {
  encode(message: CreateSubOrgzRes, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ownerId !== undefined) {
      writer.uint32(8).int32(message.ownerId);
    }
    if (message.branch !== undefined) {
      Orgz.encode(message.branch, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CreateSubOrgzRes {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateSubOrgzRes();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.branch = Orgz.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CreateSubOrgzRes {
    return {
      ownerId: isSet(object.ownerId) ? globalThis.Number(object.ownerId) : undefined,
      branch: isSet(object.branch) ? Orgz.fromJSON(object.branch) : undefined,
    };
  },

  toJSON(message: CreateSubOrgzRes): unknown {
    const obj: any = {};
    if (message.ownerId !== undefined) {
      obj.ownerId = Math.round(message.ownerId);
    }
    if (message.branch !== undefined) {
      obj.branch = Orgz.toJSON(message.branch);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CreateSubOrgzRes>, I>>(base?: I): CreateSubOrgzRes {
    return CreateSubOrgzRes.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateSubOrgzRes>, I>>(object: I): CreateSubOrgzRes {
    const message = createBaseCreateSubOrgzRes();
    message.ownerId = object.ownerId ?? undefined;
    message.branch = (object.branch !== undefined && object.branch !== null)
      ? Orgz.fromPartial(object.branch)
      : undefined;
    return message;
  },
};

function createBaseCreateSubOrgzReq(): CreateSubOrgzReq {
  return { ownerId: 0, parentorgzId: 0, branch: undefined };
}

export const CreateSubOrgzReq = {
  encode(message: CreateSubOrgzReq, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.ownerId !== 0) {
      writer.uint32(8).int32(message.ownerId);
    }
    if (message.parentorgzId !== 0) {
      writer.uint32(16).int32(message.parentorgzId);
    }
    if (message.branch !== undefined) {
      Orgz.encode(message.branch, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CreateSubOrgzReq {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateSubOrgzReq();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.parentorgzId = reader.int32();
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): CreateSubOrgzReq {
    return {
      ownerId: isSet(object.ownerId) ? globalThis.Number(object.ownerId) : 0,
      parentorgzId: isSet(object.parentorgzId) ? globalThis.Number(object.parentorgzId) : 0,
      branch: isSet(object.branch) ? Orgz.fromJSON(object.branch) : undefined,
    };
  },

  toJSON(message: CreateSubOrgzReq): unknown {
    const obj: any = {};
    if (message.ownerId !== 0) {
      obj.ownerId = Math.round(message.ownerId);
    }
    if (message.parentorgzId !== 0) {
      obj.parentorgzId = Math.round(message.parentorgzId);
    }
    if (message.branch !== undefined) {
      obj.branch = Orgz.toJSON(message.branch);
    }
  ...
  create<I extends Exact<DeepPartial<CreateSubOrgzReq>, I>>(base?: I): CreateSubOrgzReq {
    return CreateSubOrgzReq.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CreateSubOrgzReq>, I>>(object: I): CreateSubOrgzReq {
    const message = createBaseCreateSubOrgzReq();
    message.ownerId = object.ownerId ?? 0;
    message.parentorgzId = object.parentorgzId ?? 0;
    message.branch = (object.branch !== undefined && object.branch !== null)
      ? Orgz.fromPartial(object.branch)
      : undefined;
    return message;
...
export const OrgzServiceService = {
  ...
  branchCreate: {
    path: "/OrgzService/branch_create",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: CreateSubOrgzReq) => Buffer.from(CreateSubOrgzReq.encode(value).finish()),
    requestDeserialize: (value: Buffer) => CreateSubOrgzReq.decode(value),
    responseSerialize: (value: CreateSubOrgzRes) => Buffer.from(CreateSubOrgzRes.encode(value).finish()),
    responseDeserialize: (value: Buffer) => CreateSubOrgzRes.decode(value),
  },
  all: {
...
export interface OrgzServiceServer extends UntypedServiceImplementation {
  ...
  branchCreate: handleUnaryCall<CreateSubOrgzReq, CreateSubOrgzRes>;
...
export interface OrgzServiceClient extends Client {
  ...
  branchCreate(
    request: CreateSubOrgzReq,
    callback: (error: ServiceError | null, response: CreateSubOrgzRes) => void,
  ): ClientUnaryCall;
  branchCreate(
    request: CreateSubOrgzReq,
    metadata: Metadata,
